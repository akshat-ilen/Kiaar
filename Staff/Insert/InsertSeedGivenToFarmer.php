...
<html>
    <head>
        <title>Insert Seed Given To Farmer</title>
    ...
    <body>
        ...
        <?php name("Insert Seed Given To Farmer");?>
        <?php $pageFlag = "SeedGivenToFarmer";?>
        <?php include 'InsertFiles/InsertAjax.php'?>

        <h4 class="center-align">This Page is Under Construction</h4>
